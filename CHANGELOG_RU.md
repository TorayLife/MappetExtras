...
Обновления включают исправления ошибок в Arm Render и методах IScriptVector, добавление новых методов в API, удаление устаревших интерфейсов и добавление новых настроек, таких как "Путь к скриптам" и "Текст по умолчанию".
