...
public class MPEIcons {
    public static final ResourceLocation LVICONS = new ResourceLocation(MappetExtras.MOD_ID, "textures/gui/lvicons.png");
    public static final ResourceLocation KEYICONS = new ResourceLocation(MappetExtras.MOD_ID, "textures/gui/keyicons.png");

    //HORSE
    public static final Icon BULLET = new Icon(LVICONS, 0, 224);

    public static final Icon PARTICLE = new Icon(LVICONS, 16, 224);

    public static final Icon SCENE = new Icon(LVICONS, 32, 224);

    public static final Icon REWIND = new Icon(LVICONS, 48, 224);

    public static final Icon FACES = new Icon(LVICONS, 64, 224);

    public static final Icon ALEX = new Icon(LVICONS, 80, 224);

    public static final Icon SELECTOR = new Icon(LVICONS, 96, 224);

    public static final Icon SLASH = new Icon(LVICONS, 112, 224);

    public static final Icon TEXT = new Icon(LVICONS, 128, 224);

    public static final Icon LIKE = new Icon(LVICONS, 144, 224);

    public static final Icon DISLIKE = new Icon(LVICONS, 160, 224);

    public static final Icon YOUTUBE = new Icon(LVICONS, 0, 240);

    public static final Icon DISCORD = new Icon(LVICONS, 16, 240);

    public static final Icon TELEGRAM = new Icon(LVICONS, 32, 240);

    public static final Icon VK = new Icon(LVICONS, 48, 240);

    public static final Icon TWITTER = new Icon(LVICONS, 64, 240);
    ...
    public static final Icon OTHER_STATS = new Icon(LVICONS, 64, 0);

    public static final Icon OTHER_BANNER = new Icon(LVICONS, 80, 0);

    public static final Icon OTHER_OPENED_LOCK = new Icon(LVICONS, 96, 0);

    public static final Icon OTHER_CLOSED_LOCK = new Icon(LVICONS, 112, 0);

    public static final Icon OTHER_FLAG = new Icon(LVICONS, 128, 0);

    public static final Icon OTHER_FINISHFLAG = new Icon(LVICONS, 144, 0);

    public static final Icon OTHER_UMBRELLA = new Icon(LVICONS, 160, 0);

    public static final Icon OTHER_STAR = new Icon(LVICONS, 176, 0);

    public static final Icon OTHER_STAR_2 = new Icon(LVICONS, 192, 0);

    public static final Icon OTHER_DUNGEONKEY = new Icon(LVICONS, 208, 0);

    public static final Icon OTHER_CARKEY = new Icon(LVICONS, 224, 0);

    public static final Icon OTHER_KEY = new Icon(LVICONS, 240, 0);

    public static final Icon OTHER_X = new Icon(LVICONS, 0, 16);

    public static final Icon OTHER_BACKPACK = new Icon(LVICONS, 16, 16);

    public static final Icon OTHER_GLOSARY = new Icon(LVICONS, 32, 16);

    public static final Icon OTHER_BOOK = new Icon(LVICONS, 48, 16);

    public static final Icon OTHER_DOCUMENT = new Icon(LVICONS, 64, 16);

    public static final Icon OTHER_CANDLE = new Icon(LVICONS, 80, 16);

    public static final Icon OTHER_HOOK = new Icon(LVICONS, 96, 16);

    public static final Icon ADMINPANEL_USER = new Icon(LVICONS, 0, 32);

    public static final Icon ADMINPANEL_USER_WHITE_CROSS = new Icon(LVICONS, 16, 32);

    public static final Icon ADMINPANEL_USER_RED_CROSS = new Icon(LVICONS, 32, 32);

    public static final Icon ADMINPANEL_MESSAGE = new Icon(LVICONS, 48, 32);

    public static final Icon ADMINPANEL_MESSAGE_WHITE_CROSS = new Icon(LVICONS, 64, 32);

    public static final Icon ADMINPANEL_MESSAGE_RED_CROSS = new Icon(LVICONS, 80, 32);

    public static final Icon ADMINPANEL_VOICE = new Icon(LVICONS, 96, 32);

    public static final Icon ADMINPANEL_VOICE_WHITE_CROSS = new Icon(LVICONS, 112, 32);
    ...
    public static final Icon TOOLS_KNIFE = new Icon(LVICONS, 16, 48);

    public static final Icon TOOLS_DAGGER = new Icon(LVICONS, 32, 48);

    public static final Icon TOOLS_SHORTSWORD = new Icon(LVICONS, 48, 48);

    public static final Icon TOOLS_KATANA = new Icon(LVICONS, 64, 48);

    public static final Icon TOOLS_HAMMER = new Icon(LVICONS, 80, 48);

    public static final Icon TOOLS_SCREWDRIVER = new Icon(LVICONS, 96, 48);

    public static final Icon TOOLS_SHOVEL = new Icon(LVICONS, 112, 48);

    public static final Icon TOOLS_GLOVE = new Icon(LVICONS, 128, 48);

    public static final Icon TOOLS_SHURIKEN = new Icon(LVICONS, 144, 48);

    public static final Icon TOOLS_BOW = new Icon(LVICONS, 160, 48);

    public static final Icon TOOLS_LONGBOW = new Icon(LVICONS, 176, 48);

    public static final Icon TOOLS_ARROW = new Icon(LVICONS, 192, 48);

    public static final Icon TOOLS_FLYINGARROWS = new Icon(LVICONS, 208, 48);

    public static final Icon TOOLS_SHOT = new Icon(LVICONS, 224, 48);

    public static final Icon TOOLS_BULLET = new Icon(LVICONS, 240, 48);

    public static final Icon TOOLS_PISTOL = new Icon(LVICONS, 0, 64);

    public static final Icon TOOLS_GLOCK = new Icon(LVICONS, 16, 64);

    public static final Icon TOOLS_REVOLVER = new Icon(LVICONS, 32, 64);

    public static final Icon TOOLS_UZI = new Icon(LVICONS, 48, 64);

    public static final Icon TOOLS_DYNAMITE = new Icon(LVICONS, 64, 64);

    public static final Icon TOOLS_GRENADE = new Icon(LVICONS, 80, 64);

    public static final Icon TOOLS_TNT = new Icon(LVICONS, 96, 64);

    public static final Icon CLOTHES_CROWN = new Icon(LVICONS, 0, 80);

    public static final Icon CLOTHES_MINICROWN = new Icon(LVICONS, 16, 80);

    public static final Icon CLOTHES_CYLINDER = new Icon(LVICONS, 32, 80);

    public static final Icon CLOTHES_HAT = new Icon(LVICONS, 48, 80);

    public static final Icon CLOTHES_CAP = new Icon(LVICONS, 64, 80);

    public static final Icon CLOTHES_CHRISTMASHAT = new Icon(LVICONS, 80, 80);

    public static final Icon CLOTHES_FAVOUR = new Icon(LVICONS, 96, 80);

    public static final Icon CLOTHES_GLASSES = new Icon(LVICONS, 112, 80);

    public static final Icon CLOTHES_TSHORT = new Icon(LVICONS, 128, 80);

    public static final Icon CLOTHES_JACKET = new Icon(LVICONS, 144, 80);

    public static final Icon CLOTHES_PANTS = new Icon(LVICONS, 160, 80);

    public static final Icon CLOTHES_BOOTS = new Icon(LVICONS, 176, 80);
    ...
    public static final Icon DEVICE_COMPUTER_2 = new Icon(LVICONS, 32, 96);
    ...
    public static final Icon DEVICE_KEYBOARD = new Icon(LVICONS, 176, 96);

    public static final Icon DEVICE_GAMEPAD = new Icon(LVICONS, 192, 96);

    public static final Icon DEVICE_MICROPHONE = new Icon(LVICONS, 208, 96);
    ...
    public static final Icon COMPUTER_CLICK = new Icon(LVICONS, 16, 112);

    public static final Icon COMPUTER_SHUTDOWN = new Icon(LVICONS, 32, 112);

    public static final Icon COMPUTER_SETTINGS = new Icon(LVICONS, 48, 112);

    public static final Icon COMPUTER_USB = new Icon(LVICONS, 64, 112);

    public static final Icon COMPUTER_BATTERY_4 = new Icon(LVICONS, 80, 112);

    public static final Icon COMPUTER_BATTERY_3 = new Icon(LVICONS, 96, 112);

    public static final Icon COMPUTER_BATTERY_2 = new Icon(LVICONS, 112, 112);

    public static final Icon COMPUTER_BATTERY_1 = new Icon(LVICONS, 128, 112);

    public static final Icon COMPUTER_CHARGING = new Icon(LVICONS, 144, 112);

    public static final Icon COMPUTER_NOTIFICATION = new Icon(LVICONS, 160, 112);

    public static final Icon COMPUTER_DEFENDER = new Icon(LVICONS, 176, 112);

    public static final Icon COMPUTER_HOME = new Icon(LVICONS, 192, 112);

    public static final Icon COMPUTER_MAIL = new Icon(LVICONS, 208, 112);

    public static final Icon COMPUTER_MARKET = new Icon(LVICONS, 224, 112);

    public static final Icon COMPUTER_LIGHT = new Icon(LVICONS, 240, 112);

    public static final Icon COMPUTER_MAP = new Icon(LVICONS, 0, 128);

    public static final Icon COMPUTER_MAPPOINT = new Icon(LVICONS, 16, 128);

    public static final Icon COMPUTER_SHARE = new Icon(LVICONS, 32, 128);

    public static final Icon COMPUTER_SHARE_2 = new Icon(LVICONS, 48, 128);

    public static final Icon COMPUTER_FOLDER = new Icon(LVICONS, 64, 128);

    public static final Icon COMPUTER_FILE = new Icon(LVICONS, 80, 128);

    public static final Icon COMPUTER_PASTE = new Icon(LVICONS, 96, 128);

    public static final Icon COMPUTER_CREDITCARD = new Icon(LVICONS, 112, 128);

    public static final Icon COMPUTER_PIANO = new Icon(LVICONS, 128, 128);

    public static final Icon COMPUTER_CD = new Icon(LVICONS, 144, 128);

    public static final Icon COMPUTER_CASSETE = new Icon(LVICONS, 160, 128);

    public static final Icon COMPUTER_NOTE = new Icon(LVICONS, 176, 128);
    ...
    public static final Icon PAINT_HIGHLITGHTER = new Icon(LVICONS, 32, 144);

    public static final Icon PAINT_BRUSH = new Icon(LVICONS, 48, 144);
    ...
    public static final Icon FOOD_SPOON = new Icon(LVICONS, 16, 160);

    public static final Icon FOOD_MEAT = new Icon(LVICONS, 32, 160);

    public static final Icon FOOD_PIZZA = new Icon(LVICONS, 48, 160);

    public static final Icon FOOD_BREAD = new Icon(LVICONS, 64, 160);

    public static final Icon FOOD_SOUP = new Icon(LVICONS, 80, 160);

    public static final Icon FOOD_CAKE = new Icon(LVICONS, 96, 160);

    public static final Icon FOOD_CHOCOLATE = new Icon(LVICONS, 112, 160);

    public static final Icon FOOD_ICECREAM = new Icon(LVICONS, 128, 160);

    public static final Icon FOOD_ICECREAM_2 = new Icon(LVICONS, 144, 160);

    public static final Icon FOOD_CHUPACHUPS = new Icon(LVICONS, 160, 160);

    public static final Icon FOOD_LOLLIPOP = new Icon(LVICONS, 176, 160);

    public static final Icon FOOD_CHRISTMASLOLLIPOP = new Icon(LVICONS, 192, 160);

    public static final Icon FOOD_TEA = new Icon(LVICONS, 208, 160);

    public static final Icon FOOD_COFFEE = new Icon(LVICONS, 224, 160);

    public static final Icon FOOD_BEAR = new Icon(LVICONS, 240, 160);

    public static final Icon FOOD_JAM = new Icon(LVICONS, 0, 176);

    public static final Icon FOOD_CHAMPAGNE = new Icon(LVICONS, 16, 176);

    public static final Icon FOOD_COCACOLA = new Icon(LVICONS, 32, 176);

    public static final Icon FOOD_CUP = new Icon(LVICONS, 48, 176);

    public static final Icon FOOD_GLASS = new Icon(LVICONS, 64, 176);

    public static final Icon FOOD_VIAL = new Icon(LVICONS, 80, 176);

    public static final Icon FOOD_POTION = new Icon(LVICONS, 96, 176);
    ...
    public static final Icon EMOJI_RELAXED = new Icon(LVICONS, 16, 192);
    ...
    public static final Icon MONEY_COINDOLLAR = new Icon(LVICONS, 16, 208);
    ...
    public static final Icon KEY_ESCAPE = new Icon(KEYICONS, 0, 0, 32, 16);

    public static final Icon KEY_F1 = new Icon(KEYICONS, 32, 0);

    public static final Icon KEY_F2 = new Icon(KEYICONS, 48, 0);

    public static final Icon KEY_F3 = new Icon(KEYICONS, 64, 0);

    public static final Icon KEY_F4 = new Icon(KEYICONS, 80, 0);

    public static final Icon KEY_F5 = new Icon(KEYICONS, 96, 0);

    public static final Icon KEY_F6 = new Icon(KEYICONS, 112, 0);

    public static final Icon KEY_F7 = new Icon(KEYICONS, 128, 0);

    public static final Icon KEY_F8 = new Icon(KEYICONS, 144, 0);

    public static final Icon KEY_F9 = new Icon(KEYICONS, 160, 0);

    public static final Icon KEY_F10 = new Icon(KEYICONS, 176, 0);

    public static final Icon KEY_F11 = new Icon(KEYICONS, 192, 0);

    public static final Icon KEY_F12 = new Icon(KEYICONS, 208, 0);

    public static final Icon KEY_PRINT = new Icon(KEYICONS, 224, 0, 32, 16);

    public static final Icon KEY_GRAVIAS = new Icon(KEYICONS, 0, 16);

    public static final Icon KEY_TILDA = new Icon(KEYICONS, 16, 16);

    public static final Icon KEY_EXCLAMATION = new Icon(KEYICONS, 32, 16);

    public static final Icon KEY_SYMBOL = new Icon(KEYICONS, 48, 16);

    public static final Icon KEY_GRID = new Icon(KEYICONS, 64,16);

    public static final Icon KEY_DOLLAR = new Icon(KEYICONS, 80,16);

    public static final Icon KEY_PROCENT = new Icon(KEYICONS, 96,16);

    public static final Icon KEY_CARET = new Icon(KEYICONS, 112,16);

    public static final Icon KEY_AMPERSAND = new Icon(KEYICONS, 128,16);

    public static final Icon KEY_STAR = new Icon(KEYICONS, 144,16);

    public static final Icon KEY_LEFT_PARENTTHESIS = new Icon(KEYICONS, 160,16);

    public static final Icon KEY_RIGHT_PARENTTHESIS = new Icon(KEYICONS, 176,16);

    public static final Icon KEY_INSERT = new Icon(KEYICONS, 192,16, 32, 16);

    public static final Icon KEY_HOME = new Icon(KEYICONS, 224, 16, 32, 16);

    public static final Icon KEY_1 = new Icon(KEYICONS, 0,32);

    public static final Icon KEY_2 = new Icon(KEYICONS, 16,32);

    public static final Icon KEY_3 = new Icon(KEYICONS, 32,32);

    public static final Icon KEY_4 = new Icon(KEYICONS, 48,32);

    public static final Icon KEY_5 = new Icon(KEYICONS, 64,32);

    public static final Icon KEY_6 = new Icon(KEYICONS, 80,32);

    public static final Icon KEY_7 = new Icon(KEYICONS, 96,32);

    public static final Icon KEY_8 = new Icon(KEYICONS, 112,32);

    public static final Icon KEY_9 = new Icon(KEYICONS, 128,32);

    public static final Icon KEY_0 = new Icon(KEYICONS, 144,32);

    public static final Icon KEY_MINUS = new Icon(KEYICONS, 160,32);

    public static final Icon KEY_UNDERLINE = new Icon(KEYICONS, 176,32);

    public static final Icon KEY_EQUALS = new Icon(KEYICONS, 192,32);

    public static final Icon KEY_PLUS = new Icon(KEYICONS, 208,32);

    public static final Icon KEY_BACKSPACE = new Icon(KEYICONS, 224, 32, 32, 16);

    public static final Icon KEY_TAB = new Icon(KEYICONS, 0, 48, 32, 16);

    public static final Icon KEY_Q = new Icon(KEYICONS, 32,48);

    public static final Icon KEY_W = new Icon(KEYICONS, 48,48);

    public static final Icon KEY_E = new Icon(KEYICONS, 64,48);

    public static final Icon KEY_R = new Icon(KEYICONS, 80,48);

    public static final Icon KEY_T = new Icon(KEYICONS, 96,48);

    public static final Icon KEY_Y = new Icon(KEYICONS, 112,48);

    public static final Icon KEY_U = new Icon(KEYICONS, 128,48);

    public static final Icon KEY_I = new Icon(KEYICONS, 144,48);

    public static final Icon KEY_O = new Icon(KEYICONS, 160,48);

    public static final Icon KEY_P = new Icon(KEYICONS, 176,48);

    public static final Icon KEY_LEFT_BRACKET = new Icon(KEYICONS, 192,48);

    public static final Icon KEY_LEFT_BRACE = new Icon(KEYICONS, 208,48);

    public static final Icon KEY_RIGHT_BRACKET = new Icon(KEYICONS, 224,48);

    public static final Icon KEY_RIGHT_BRACE = new Icon(KEYICONS, 240,48);

    public static final Icon KEY_CAPSLOCK = new Icon(KEYICONS, 0,64, 32, 16);

    public static final Icon KEY_A = new Icon(KEYICONS, 32,64);

    public static final Icon KEY_S = new Icon(KEYICONS, 48,64);

    public static final Icon KEY_D = new Icon(KEYICONS, 64,64);

    public static final Icon KEY_F = new Icon(KEYICONS, 80,64);

    public static final Icon KEY_G = new Icon(KEYICONS, 96,64);

    public static final Icon KEY_H = new Icon(KEYICONS, 112,64);

    public static final Icon KEY_J = new Icon(KEYICONS, 128,64);

    public static final Icon KEY_K = new Icon(KEYICONS, 144,64);

    public static final Icon KEY_L = new Icon(KEYICONS, 160,64);

    public static final Icon KEY_SEMICOLON = new Icon(KEYICONS, 176,64);

    public static final Icon KEY_COLON = new Icon(KEYICONS, 192,64);

    public static final Icon KEY_SINGLE_QUOTE = new Icon(KEYICONS, 208,64);

    public static final Icon KEY_QUOTATION_MARK = new Icon(KEYICONS, 224,64);

    public static final Icon KEY_UP_ARROW = new Icon(KEYICONS, 240,64);

    public static final Icon KEY_SHIFT = new Icon(KEYICONS, 0, 80, 32, 16);

    public static final Icon KEY_Z = new Icon(KEYICONS, 32,80);

    public static final Icon KEY_X = new Icon(KEYICONS, 48,80);

    public static final Icon KEY_C = new Icon(KEYICONS, 64,80);

    public static final Icon KEY_V = new Icon(KEYICONS, 80,80);

    public static final Icon KEY_B = new Icon(KEYICONS, 96,80);

    public static final Icon KEY_N = new Icon(KEYICONS, 112,80);

    public static final Icon KEY_M = new Icon(KEYICONS, 128,80);

    public static final Icon KEY_COMMA = new Icon(KEYICONS, 144,80);

    public static final Icon KEY_LEFT_ANGLE_BRACKET = new Icon(KEYICONS, 160,80);

    public static final Icon KEY_DOT = new Icon(KEYICONS, 176,80);

    public static final Icon KEY_RIGHT_ANGLE_BRACKET = new Icon(KEYICONS, 192,80);

    public static final Icon KEY_SLASH = new Icon(KEYICONS, 208,80);

    public static final Icon KEY_QUESTION = new Icon(KEYICONS, 224,80);

    public static final Icon KEY_DOWN_ARROW = new Icon(KEYICONS, 240,80);

    public static final Icon KEY_CTRL = new Icon(KEYICONS, 0, 96, 32, 16);

    public static final Icon KEY_WINDOW = new Icon(KEYICONS, 32, 96);

    public static final Icon KEY_ALT = new Icon(KEYICONS, 48, 96, 32, 16);

    public static final Icon KEY_SPACE_SMALL = new Icon(KEYICONS, 80, 96);

    public static final Icon KEY_SPACE_MEDIUM = new Icon(KEYICONS, 96, 96, 32, 16);

    public static final Icon KEY_SPACE_LARGE = new Icon(KEYICONS, 128, 96, 64, 16);

    public static final Icon KEY_LEFT_ARROW = new Icon(KEYICONS, 192, 96);

    public static final Icon KEY_RIGHT_ARROW = new Icon(KEYICONS, 192, 208);

    public static final Icon KEY_FN = new Icon(KEYICONS, 208, 96);

    public static final Icon KEY_RIGHT_SHIFT = new Icon(KEYICONS, 224, 96, 32, 16);

    public static final Icon KEY_SCROLL_LOCK = new Icon(KEYICONS, 192, 112, 32, 16);

    public static final Icon KEY_PAUSE = new Icon(KEYICONS, 224, 112, 32, 16);

    public static final Icon KEY_DELETE = new Icon(KEYICONS, 192, 128, 32, 16);

    public static final Icon KEY_END = new Icon(KEYICONS, 224, 128, 32, 16);

    public static final Icon KEY_PAGE_UP = new Icon(KEYICONS, 192, 144, 32, 16);

    public static final Icon KEY_PAGE_DOWN = new Icon(KEYICONS, 224, 144, 32, 16);

    public static final Icon KEY_BACKSLASH = new Icon(KEYICONS, 192, 160);

    public static final Icon KEY_VERTICAL_SLASH = new Icon(KEYICONS, 208, 160);

    public static final Icon KEY_NUMLCOK = new Icon(KEYICONS, 224, 160, 32, 16);

    public static final Icon KEY_ENTER = new Icon(KEYICONS, 192, 176, 32, 16);

    public static final Icon KEY_ENTER_TWO = new Icon(KEYICONS, 224, 176, 32, 16);

    public static final Icon KEY_CAPSLOCK_TWO = new Icon(KEYICONS, 192, 192, 32, 16);

    public static final Icon KEY_TAB_TWO = new Icon(KEYICONS, 224, 192, 32, 16);
